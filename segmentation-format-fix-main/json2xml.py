...
test_files = []
if isUseTest:
    trainval_files, test_files = train_test_split(total_files, test_size=0, random_state=55)
else:
...
# split
train_files, val_files = train_test_split(trainval_files, test_size=0, random_state=55)
